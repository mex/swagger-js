...
"use strict";function optionHtml(e,t){return'<tr><td class="optionName">'+e+":</td><td>"+t+"</td></tr>"}function typeFromJsonSchema(e,t){var i;return"integer"===e&&"int32"===t?i="integer":"integer"===e&&"int64"===t?i="long":"integer"===e&&"undefined"==typeof t?i="long":"string"===e&&"date-time"===t?i="date-time":"string"===e&&"date"===t?i="date":"number"===e&&"float"===t?i="float":"number"===e&&"double"===t?i="double":"number"===e&&"undefined"==typeof t?i="double":"boolean"===e?i="boolean":"string"===e&&(i="string"),i}function getStringSignature(e,t){var i="";return"undefined"!=typeof e.$ref?i+=Helpers.simpleRef(e.$ref):"undefined"==typeof e.type?i+="object":"array"===e.type?t?i+=getStringSignature(e.items||e.$ref||{}):(i+="Array[",i+=getStringSignature(e.items||e.$ref||{}),i+="]"):i+="integer"===e.type&&"int32"===e.format?"integer":"integer"===e.type&&"int64"===e.format?"long":"integer"===e.type&&"undefined"==typeof e.format?"long":"string"===e.type&&"date-time"===e.format?"date-time":"string"===e.type&&"date"===e.format?"date":"string"===e.type&&"undefined"==typeof e.format?"string":"number"===e.type&&"float"===e.format?"float":"number"===e.type&&"double"===e.format?"double":"number"===e.type&&"undefined"==typeof e.format?"double":"boolean"===e.type?"boolean":e.$ref?Helpers.simpleRef(e.$ref):e.type,i}function schemaToJSON(e,t,i,n){e=Helpers.resolveSchema(e),"function"!=typeof n&&(n=function(e){return(e||{}).default}),i=i||{};var r,o,s=e.type||"object",a=e.format;return _.isUndefined(e.example)?_.isUndefined(e.items)&&_.isArray(e.enum)&&(o=e.enum[0]):o=e.example,_.isUndefined(o)&&(e.$ref?(r=t[Helpers.simpleRef(e.$ref)],_.isUndefined(r)||(_.isUndefined(i[r.name])?(i[r.name]=r,o=schemaToJSON(r.definition,t,i,n),delete i[r.name]):o="array"===r.type?[]:{})):_.isUndefined(e.default)?"string"===s?o="date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string":"integer"===s?o=0:"number"===s?o=0:"boolean"===s?o=!0:"object"===s?(o={},_.forEach(e.properties,function(e,r){var s=_.cloneDeep(e);s.default=n(e),o[r]=schemaToJSON(s,t,i,n)})):"array"===s&&(o=[],_.isArray(e.items)?_.forEach(e.items,function(e){o.push(schemaToJSON(e,t,i,n))}):_.isPlainObject(e.items)?o.push(schemaToJSON(e.items,t,i,n)):_.isUndefined(e.items)?o.push({}):Helpers.log("Array type's 'items' property is not an array or an object, cannot process")):o=e.default),o}function schemaToHTML(e,t,i,n){function r(e,t,n){var r,o=t;return e.$ref?(o=e.title||Helpers.simpleRef(e.$ref),r=i[o],null!==r&&null!==r.definition.title&&"undefined"!=typeof r.definition.title&&(o=r.definition.title)):_.isUndefined(t)&&(o=e.title||"Inline Model "+ ++f,r={definition:e}),n!==!0&&(m[o]=_.isUndefined(r)?{}:r.definition),o}function o(e){var t,i='<span class="propType"',n=e.type||"object";return e.$ref?(t=r(e,Helpers.simpleRef(e.$ref)),i+=i+=" title="+t+">"+t):"object"===n?_.isUndefined(e.properties)?i+=' title="object">object':(t=r(e),i+=" title="+t+">"+t):"array"===n?(_.isArray(e.items)?t=_.map(e.items,r).join(","):_.isPlainObject(e.items)?t=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||_.indexOf(["array","object"],e.items.type)!==-1?r(e.items):e.items.type:r(e.items,Helpers.simpleRef(e.items.$ref)):(Helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),t="object"),i+=" title=array["+t+"]>array["+t+"]"):i+=" title="+e.type+">"+e.type,i+="</span>"}function s(e,t){var i="",n=e.type||"object",r="array"===n;switch(r&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e.format)||(i+=optionHtml("Format","<code>"+e.format+"</code>")),_.isUndefined(e.default)||(i+=optionHtml("Default",e.default)),n){case"string":e.minLength&&e.maxLength&&e.minLength===e.maxLength?i+=optionHtml("Length",e.minLength):(e.minLength&&(i+=optionHtml("Min. length",e.minLength)),e.maxLength&&(i+=optionHtml("Max. length",e.maxLength))),e.pattern&&(i+=optionHtml("Reg. exp.",e.pattern));break;case"integer":case"number":e.minimum&&(i+=optionHtml("Min. value",e.minimum)),e.exclusiveMinimum&&(i+=optionHtml("Exclusive min.","yes")),e.maximum&&(i+=optionHtml("Max. value",e.maximum)),e.exclusiveMaximum&&(i+=optionHtml("Exclusive max.","yes")),e.multipleOf&&(i+=optionHtml("Multiple of",e.multipleOf))}if(r&&(e.minItems&&(i+=optionHtml("Min. items",e.minItems)),e.maxItems&&(i+=optionHtml("Max. items",e.maxItems)),e.uniqueItems&&(i+=optionHtml("Unique items","yes")),e.collectionFormat&&(i+=optionHtml("Coll. format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e.enum)){var o;o="number"===n||"integer"===n?e.enum.join(", "):'"'+e.enum.join('", "')+'"',i+=optionHtml("Enum",o)}return i.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+i+"</table></span>"),t}function a(e,t){var a=e.type||"object",p="array"===e.type,l='<span class="strong objectName"><span class="bracketsIcon">'+(p?"[]":"{}")+'</span> <span class="objectNameText">',m="</span></span>",f="";if(t.indexOf("Inline Model")===-1&&(f=_.isUndefined(e.title)?l+t+m:l+e.title+m),t&&d.push(t),p)if(_.isArray(e.items))f+="<div>"+_.map(e.items,function(e){var t=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],t)>-1?"object"===t&&_.isUndefined(e.properties)?"object":r(e):s(e,t):r(e,Helpers.simpleRef(e.$ref))}).join("</div><div>");else if(_.isPlainObject(e.items)){var c="";c=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"object":r(e.items):s(e.items,e.items.type):r(e.items,Helpers.simpleRef(e.items.$ref)),"Inline Model"!==t&&(f+="<div>"+c+"</div>")}else Helpers.log("Array type's 'items' property is not an array or an object, cannot process"),f+="<div>object</div>";else if(e.$ref)f+="<div>"+r(e,t)+"</div>";else if("object"===a){if(_.isPlainObject(e.properties)){var u=_.map(e.properties,function(t,r){var a,p=_.indexOf(e.required,r)>=0,l=_.cloneDeep(t),m='<span class="propLabels">';m+='<span class="propName propOpt">'+r+"</span>";var d;return l.default=n(l),l=Helpers.resolveSchema(l),d=t.description||l.description,_.isUndefined(l.$ref)||(a=i[Helpers.simpleRef(l.$ref)],_.isUndefined(a)||_.indexOf([void 0,"array","object"],a.definition.type)!==-1||(l=Helpers.resolveSchema(a.definition))),m+=o(l),p||(m+='<span class="propOptKey">(optional)</span>'),t.readOnly&&(m+=', <span class="propReadOnly">read only</span>'),m+="</span>",m+='<span class="propDesc">',_.isUndefined(d)||(m+=t.description),l.enum&&(m+='<div class="propVals">Can be ',_.forEach(l.enum,function(e,t){m+="<code>"+e+"</code>",t===l.enum.length-2?m+=" or ":t<l.enum.length-1&&(m+=", ")}),m+="</div>"),m+="</span>","<div"+(t.readOnly?' class="readOnly"':"")+">"+s(l,m)}).join("</div>");u&&(f+=u+"</div>")}}else f+="<div>"+s(e,a)+"</div>";return f}var p='<span class="strong">',l="</span>";if(_.isObject(arguments[0])&&(e=void 0,t=arguments[0],i=arguments[1],n=arguments[2]),i=i||{},t=Helpers.resolveSchema(t),_.isEmpty(t))return p+"Empty"+l;if("string"==typeof t.$ref&&(e=Helpers.simpleRef(t.$ref),t=i[e],"undefined"==typeof t))return p+e+" is not defined!"+l;"string"!=typeof e&&(e=t.title||"Inline Model"),t.definition&&(t=t.definition),"function"!=typeof n&&(n=function(e){return(e||{}).default});for(var m={},d=[],f=0,c=a(t,e);_.keys(m).length>0;)_.forEach(m,function(e,t){var i=_.indexOf(d,t)>-1;delete m[t],i||(d.push(t),c+=a(e,t))});return c}var Helpers=require("./helpers"),_={isPlainObject:require("lodash-compat/lang/isPlainObject"),isUndefined:require("lodash-compat/lang/isUndefined"),isArray:require("lodash-compat/lang/isArray"),isObject:require("lodash-compat/lang/isObject"),isEmpty:require("lodash-compat/lang/isEmpty"),map:require("lodash-compat/collection/map"),indexOf:require("lodash-compat/array/indexOf"),cloneDeep:require("lodash-compat/lang/cloneDeep"),keys:require("lodash-compat/object/keys"),forEach:require("lodash-compat/collection/forEach")};module.exports.optionHtml=optionHtml,module.exports.typeFromJsonSchema=typeFromJsonSchema,module.exports.getStringSignature=getStringSignature,module.exports.schemaToHTML=schemaToHTML,module.exports.schemaToJSON=schemaToJSON;
